  ...
  return (
    <div className='w-full h-[300px] md:h-[550px]  flex flex-col justify-between items-center  border-t-3xl bg-[white] '>
        ...
        <div className='flex text-3xl '>
                ...
                <a href='https://www.linkedin.com/in/sanjay-acharya-693a58121/' target="_blank" alt='LinkedIn'>  <AiFillLinkedin className='m-2 text-3xl'/></a>
                <a href='https://github.com/Sanjay-acharya-au50' target="_blank" alt='GitHub'>  <AiFillGithub className='m-2 text-3xl'/></a>
          <a href='https://www.instagram.com/sanju_93__/' target="_blank" alt='instagram' >  <AiOutlineInstagram className='m-2 text-3xl'/> </a>
                <a href='https://www.facebook.com/sanjay.acharya.98229' target="_blank" alt='Facebook'>  <AiFillFacebook className='m-2 text-3xl'/></a>
